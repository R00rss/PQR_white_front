...
import { ContextoSearch } from "../../pages/Ticket/SearchTicket";
...
export default function TicketsPendientes({
  ...
  //console.log("Estos son los tickets existentes: ", tickets);
  ...
  const nextPage = () => {
    if (
      ...
      tickets.filter((ticket) =>
        [ticket.user.fullname, ticket.status].some((field) =>
  ...
  function handleShowPopUp(id: number) {
    console.log(id);
    const selectedProduct_ = getSelectedItem(id, "Abiertos");
