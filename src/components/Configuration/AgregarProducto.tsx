...
import { create_product, delete_product, update_product } from "../../services/product";
...
function PopEliminar({ onClosePopUp, getData, selectedProduct }: PopUpDeleteProps) {
  ...
  return (
    <div className="flex flex-col items-center bg-blanco w-[600px] rounded-lg h-[200px]">
      ...
      <div className=" flex flex-col w-[70%] h-[85%]">
        ...
        {/* fila 2 */}
        <div className="flex flex-row py-4">
          <p className="text-2xl font-medium">Esta seguro que desea eliminar el Producto ?</p>
        ...
        <div className="flex justify-center text-sm font-medium text-morado pb-2 pt-5">
          <button className="w-[90px] h-[35px] mx-[5%] border border-morado rounded-md duration-100 hover:bg-green-400 hover:text-blanco" onClick={()=>{deleteProduct()}}>
            Confirmar
          </button>
          <button
            className="w-[90px] h-[35px] mx-[5%] border border-morado rounded-md duration-100 hover:bg-red-400 hover:text-blanco"
